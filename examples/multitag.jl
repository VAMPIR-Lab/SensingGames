    ...
    for solvers in [
        ...
        for s = 1:50
            ...
            for t in 1:n_steps
                ...
                params = solve(planning_multitag_game, joint_belief, params, cost_fns, optimization_options)
            ...
            println("Active: $(sum(scores_active)/n_steps), Inactive: $(sum(scores_inactive)/n_steps)")
        end
    end
end
